      ...
      <div className="relative h-full px-[20px] md:px-14 pt-[15px] md:px-14 w-full">
        {
          ...
          isDesktopOrLaptop ?
            (
              ...
              <>
                <Header showSearchBar={true} showSubHeader={true} header={'Welcome to VISION - test'} />
            ...
            isTabletOrMobile ? (
              ...
              <>
                <HeaderMobile showSearchBar={true} showSubHeader={true} header={'Welcome to VISION - test'} />
