      ...
      <div className="relative h-full px-14 pt-14">
        <div className="flex">
          <div className="">
            ...
            <span className="text-xl italic text-slate-500">See the world right in front of you</span>
          </div>
        ...
        <div className="flex flex-row gap-10 pt-10">
            <div className='w-1/2 h-auto'>
              <div className="grid grid-cols-2 gap-4">
                <VCard {...{className: "relative rounded-3xl bg-vision-blue h-40"}}>
                    <div className="absolute border border-vision-lighter-blue top-4 left-4 bg-vision-light-blue rounded-3xl">
                      <img src="./images/camera-white.png" alt="Camera" className="p-4" />
                    </div>
                ...
                <VCard {...{className: "relative rounded-3xl bg-vision-yellow h-40"}}>
                    <div className="absolute border border-vision-lighter-yellow top-4 left-4 bg-vision-light-yellow rounded-3xl">
                      <img src="./images/rectangle-white.png" alt="Camera" className="p-4" />
                    </div>
                    <div className="absolute left-4 bottom-4">
                      <p className="flex flex-col text-white">
                ...
                <VCard {...{className: "relative rounded-3xl bg-vision-sky h-40"}}>
                    <div className="absolute border border-vision-lighter-sky top-4 left-4 bg-vision-light-sky rounded-3xl">
                      <img src="./images/calendar-white.png" alt="Camera" className="p-4" />
                    </div>
                    <div className="absolute left-4 bottom-4">
                      <p className="flex flex-col text-white">
                        <span>Schedule</span>
                ...
                <VCard {...{className: "relative rounded-3xl bg-vision-green h-40"}}>
                    <div className="absolute border border-vision-lighter-green top-4 left-4 bg-vision-light-green rounded-3xl">
                      <img src="./images/screen-white.png" alt="Camera" className="p-4" />
                    </div>
                    <div className="absolute left-4 bottom-4">
                      <p className="flex flex-col text-white">
              ...
              <VCard {...{className: "rounded-3xl border h-40 bg-vision-cyan"}}>
                  <div className="flex flex-row h-full pl-10">
                    <p className="flex flex-col w-1/2 my-auto text-white">
                      <span className="text-4xl font-bold tracking-wide">10:45 PM</span>
                      <span className="text-slate-300">Monday, February 6 2022</span>
                    </p>
                    <div className="relative w-1/2">
                      <img src="/images/cloud.png" alt="cloud" className="absolute top-0 h-20 right-4 blur-sm"/> 
                      <img src="/images/cloud.png" alt="cloud" className="absolute bottom-0 left-0 h-14 blur-md"/>
                      <img src="/images/cham2.png" alt="cham" className="absolute scale-75 -top-20"/>
                    </div>
                  </div>
              </VCard>
              <VCard {...{className: "rounded-3xl border h-40"}}>
                  <div>
                    02
                  </div>
              </VCard>
