...
const CreateMeeting = (props:any) => {
    ...
    const setupEmailsInvited = async (data: any) => {
        if(!invitedEmails.find((e: string) => e == data.target.defaultValue)) {
        ...
        console.log('invitedEmailsCheckbox', invitedEmailsCheckbox)
    }
    ...
    const clickedExistingContactsSendInvite = async (d: any, meeting_data: any, emails: string[]) => {
        ...
        const res = await sendEmailNotification({
            ...
            url: " https://7856-2001-4455-459-b900-cdf7-ec04-c5e9-20da.ngrok.io",
            topic: `${topic}`,
    ...
    const onSetMeetingClick = async () => {
        ...
        setTopic('');
        setDurationTimeHours('');
        setDurationTimeMinutes('');
        setStartDate('');
        setStartTime('');
        setEditorState(EditorState.createEmpty());

        toast.success("Successfully created meeting!")
    ...
    return (
          ...
          <div className="create-meeting-form mt-5">
            ...
            <div className="mb-5">
                ...
                <div className="mb-5">
                    <VLabel htmlFor="topic" className="text-[#747474]">Topic</VLabel>
                    <VInput id="topic" className="border-[#747474] bg-white text-[#747474]" value={topic} onChange={(e:any) => onTopicChange(e.target.value)} />
                </div>
                
                <div className="mb-5">
                    <VLabel htmlFor="topic-details" className="text-[#747474]">Topic Details</VLabel>
                    <VRichTextEditor
                    id="topic-details" 
                    editorState={editorState} 
                    onEditorStateChange={onEditorStateChange}
                    editorStyle={{ height: '200px' }}
                    wrapperClassName="v-rte-wrapper box-border v-ui-element border-[#747474] bg-white text-[#747474]"
                    />
                </div>

                <div className="flex mb-5">
                    <div className="w-1/2 mr-2">
                        <VLabel htmlFor="start-date" className="text-[#747474]">Start Date</VLabel>
                        <VInput type="date" className="border-[#747474] bg-white text-[#747474]" id="start-date" value={startDate} onChange={(e:any) => onStartDateChange(e.target.value)} />
                    </div>

                    <div className="w-1/2 ml-2">
                        <VLabel htmlFor="set-time" className="text-[#747474]">Set Time</VLabel>
                        <VInput type="time" className="border-[#747474] bg-white text-[#747474]" id="set-time" value={startTime} onChange={(e:any) => onStartTimeChange(e.target.value)} />
                    </div>
                </div>

                <div className="mb-5">
                    <VLabel className="text-[#747474]">Set Duration Time</VLabel>
                    <div className="flex">
                        <div className="w-1/2 mr-2">
                            <VSelect 
                                id="duration-time-h"
                                className="border-[#747474] bg-white text-[#747474]"
                                options={hourOptions}
                ...
                <div className="mb-5">
                    <VLabel className="text-[#747474]">Set Attendees</VLabel>
                    <div className="flex">
                                ...
                                <tbody className=''>
                                    {contacts.map((d, i) => (
                                        <tr key={"tr-" + i} className='r'>
                                            <td>
                                                <span className='text-[#747474] flex flex-row items-center gap-5'>
                                            ...
                                            <td className='text-right text-[#747474]'>
