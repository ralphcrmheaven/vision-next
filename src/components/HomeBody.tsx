    ...
    return (
        <>
            <div className='h-screen'>
                <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-12 lg:grid-cols-12 gap-5 pt-10 justify-between">
                    <div className="col-span-1 sm:col-span-1 md:col-span-5 lg:col-span-5 justify-start last:pb-10">
                        <div className="home-responsive-1">
                            ...
                            <VCard
                                ...
                                <VCard
                                    {...{ className: 'relative vision-card  bg-vision-green text-white h-40 cursor hover:bg-vision-lighter-green hover:text-white' }}
                                >
                                ...
                                <VCard
                                    {...{ className: 'relative vision-card bg-vision-sky text-white h-40 hover:bg-vision-lighter-sky hover:text-white' }}
                                >
                    ...
                    <div className="flex justify-end col-span-1 sm:col-span-1 md:col-span-7 lg:col-span-7 gap-3 pb-5 ">
                        <div className="home-responsive-2 w-full">
                            <div>
